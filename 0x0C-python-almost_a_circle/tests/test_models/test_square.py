...
class SquareTest(unittest.TestCase):
    ...
    def test_C(self):
        ...
        with self.assertRaises(TypeError) as e:
            r = Square()
            s = "__init__() missing 1 required argument: 'size'"
    ...
    def test_D(self):
        ...
        with self.assertRaises(TypeError) as e:
            r = Square(1, 2, 3, 4, 7)
            s = "__init__() takes from 2 to 5 arguments but 6 \
            were given"
            self.assertEqual(str(e.exception), s)
    ...
    def test_m(self):
        with self.assertRaises(TypeError) as x:
            r = Square()
        self.assertEqual(
            "__init__() missing 1 required argument: 'size'",
            str(x.exception))
