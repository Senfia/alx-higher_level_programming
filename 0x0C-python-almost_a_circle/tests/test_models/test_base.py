...
from models.square import Squares
...
class BaseTest(unittest.TestCase):
    ...
    def test_D_constructor(self):
        ...
        with self.assertRaises(TypeError) as e:
            Base.__init__()
        msg = "__init__() missing 1 required argument: 'self'"
    ...
    def test_D_constructor_args_2(self):
        ...
        msg = "__init__() takes from 1 to 2 arguments but 3 \
were given"
        self.assertEqual(str(e.exception), msg)
    ...
    def test_F_id_synced(self):
        """Tests if there is sync between class and instance id."""
        b = Base()
    ...
    def test_G_id_keyword(self):
        """Tests if id is passed as keyword arg."""
        i = 421
        b = Base(id=i)
        self.assertEqual(b.id, i)
    ...
    def test_json_no_args(self):
        with self.assertRaises(TypeError) as e:
            res = Base.to_json_string()
        self.assertEqual("to_json_string() missing 1 required " +
    ...
    def test_save_to_file_no_args(self):
        ...
        self.assertEqual("save_to_file() missing 1 required " +
    ...
    def test_from_json_string_no_arg(self):
        with self.assertRaises(TypeError) as e:
            list_output = Base.from_json_string()
        self.assertEqual("from_json_string() missing 1 required " +
